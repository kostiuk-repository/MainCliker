...
public class GoldShovel extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "GOLD_SHOVEL";
    private int onMode = R.mipmap.gold_shovel_on;
    private int offMode = R.mipmap.gold_shovel_off;
    private int help = R.mipmap.gold_shovel_craft;
    private BaseJobController baseJobController;
    private static GoldShovel instance;
    ...
    public static synchronized GoldShovel getInstance(Context context) {
        if (instance == null) {
            instance = new GoldShovel(context);
        }
        return instance;
    }


    private GoldShovel(Context context) {
        super(context);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(Crafttable.getInstance(context).getIT().getViewCounter()>=1
                        ...
                        && GoldIngot.getInstance(context).getIT().getViewCounter()>=1) {
                    changeStateIfClick();
