...
public class Saddle extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "Saddle";
    private int onMode = R.mipmap.saddle_on;
    private int offMode = R.mipmap.saddle_off;
    private int help = R.mipmap.saddle_craft;
    private BaseJobController baseJobController;
    private static Saddle instance;
    ...
    public static synchronized Saddle getInstance(Context context) {
        if (instance == null) {
            instance = new Saddle(context);
        }
        return instance;
    }


    private Saddle(Context context) {
        super(context);
        ...
        baseJobController = new BaseJobController.Builder(context)
                ...
                .setStatuses(STATUS.NOTHING,STATUS.NOTHING,STATUS.MINUS,STATUS.NOTHING)
                .setMinusValueList(0,0,-3,0)
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(Crafttable.getInstance(context).getIT().getViewCounter()>=1
                        && VillagerLeather.getInstance(context).getIT().getViewCounter()>=1
                        && Leather.getInstance(context).getIT().getViewCounter()>=3) {
                    changeStateIfClick();
