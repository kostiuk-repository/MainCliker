...
public class VillagerLeather extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "VILLAGER_LEATHER";
    private int onMode = R.mipmap.villager_leather_on;
    private int offMode = R.mipmap.villager_leather_off;
    private int help = R.mipmap.villager_leather_craft;
    private BaseJobController baseJobController;
    private static VillagerLeather instance;
    ...
    public static synchronized VillagerLeather getInstance(Context context) {
        if (instance == null) {
            instance = new VillagerLeather(context);
        }
        return instance;
    }


    private VillagerLeather(Context context) {
        super(context);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(VillagerMayor.getInstance(context).getIT().getViewCounter()>=1
                        && Leather.getInstance(context).getIT().getViewCounter()>=1
