...
public class DiamonSipitr extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "DiamonSipitr";
    private int onMode = R.mipmap.diamon_sipitr_on;
    private int offMode = R.mipmap.diamon_sipitr_off;
    private int help = R.mipmap.diamon_sipitr_craft;
    private BaseJobController baseJobController;
    private static DiamonSipitr instance;
    ...
    public static synchronized DiamonSipitr getInstance(Context context) {
        if (instance == null) {
            instance = new DiamonSipitr(context);
        }
        return instance;
    }


    private DiamonSipitr(Context context) {
        super(context);
