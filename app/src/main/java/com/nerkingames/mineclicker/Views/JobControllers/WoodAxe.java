...
public class WoodAxe extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "AXE";
    private int onMode = R.mipmap.wood_axe_on;
    private int offMode = R.mipmap.wood_axe_off;
    private int help = R.mipmap.wood_axe_craft;
    private BaseJobController baseJobController;
    private static WoodAxe instance;
    ...
    public static synchronized WoodAxe getInstance(Context context) {
        if (instance == null) {
            instance = new WoodAxe(context);
        }
        return instance;
    }


    private WoodAxe(Context context) {
        super(context);
