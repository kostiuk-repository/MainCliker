...
public class DiamondSword extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "DIAMOND_SWORD";
    private int onMode = R.mipmap.diamond_sword_on;
    private int offMode = R.mipmap.diamond_sword_off;
    private int help = R.mipmap.diamond_sword_craft;
    ...
    public static synchronized DiamondSword getInstance(Context context) {
        if (instance == null) {
            instance = new DiamondSword(context);
        }
        return instance;
    }


    private DiamondSword(Context context) {
        super(context);
