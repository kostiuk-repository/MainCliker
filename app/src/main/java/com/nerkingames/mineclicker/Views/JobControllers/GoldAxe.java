...
public class GoldAxe extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "GOLD_AXE";
    private int onMode = R.mipmap.gold_axe_on;
    private int offMode = R.mipmap.gold_axe_off;
    private int help = R.mipmap.gold_axe_craft;
    private BaseJobController baseJobController;
    private static GoldAxe instance;
    ...
    public static synchronized GoldAxe getInstance(Context context) {
        if (instance == null) {
            instance = new GoldAxe(context);
        }
        return instance;
    }


    private GoldAxe(Context context) {
        super(context);
