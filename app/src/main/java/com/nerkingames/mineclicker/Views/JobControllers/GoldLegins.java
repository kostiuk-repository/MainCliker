...
public class GoldLegins extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "GoldLegins";
    private int onMode = R.mipmap.gold_legins_on;
    private int offMode = R.mipmap.gold_legins_off;
    private int help = R.mipmap.gold_legins_craft;
    private BaseJobController baseJobController;
    private static GoldLegins instance;
    ...
    public static synchronized GoldLegins getInstance(Context context) {
        if (instance == null) {
            instance = new GoldLegins(context);
        }
        return instance;
    }


    private GoldLegins(Context context) {
        super(context);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(VillagerWorkerGold.getInstance(context).getIT().getViewCounter()>=1
                        && GoldIngot.getInstance(context).getIT().getViewCounter()>=7) {
                    changeStateIfClick();
