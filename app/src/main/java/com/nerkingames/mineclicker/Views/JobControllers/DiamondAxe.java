...
public class DiamondAxe extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "DIAMOND_AXE";
    private int onMode = R.mipmap.diamond_axe_on;
    private int offMode = R.mipmap.diamond_axe_off;
    private int help = R.mipmap.diamond_axe_craft;
    ...
    public static synchronized DiamondAxe getInstance(Context context) {
        if (instance == null) {
            instance = new DiamondAxe(context);
        }
        return instance;
    }


    private DiamondAxe(Context context) {
        super(context);
