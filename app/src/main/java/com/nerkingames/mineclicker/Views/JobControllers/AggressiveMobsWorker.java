...
public class AggressiveMobsWorker extends BaseJobController implements View.OnTouchListener{
    ...
    private int onMode = R.mipmap.villager_agressivemob_fire_on;
    private int offMode = R.mipmap.villager_agressivemob_fire_off;
    private int help = R.mipmap.villager_agressivemob_fire_craft;
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(upBarLeftSide.getTextFieldCounter() < 150
                    ...
                    if(baseJobController.getIT().getViewCounter()<=1
                            && GoodMobsWorker.getInstance(context).getIT().getViewCounter() == 0) {
