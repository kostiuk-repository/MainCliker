...
public class Furnece extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "FURNECE";
    private final Context context;
    private int onMode = R.mipmap.furnece_on;
    private int offMode = R.mipmap.furnece_off;
    private int help = R.mipmap.furnece_craft;
    private BaseJobController baseJobController;
    private static Furnece instance;
    ...
    public static synchronized Furnece getInstance(Context context) {
        if (instance == null) {
            instance = new Furnece(context);
        }
        return instance;
    }


    private Furnece(Context context) {
        super(context);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(Crafttable.getInstance(context).getIT().getViewCounter()>=1
                        && Cobbl.getInstance(context).getIT().getViewCounter()>=8) {
                    changeStateIfClick();
