...
public class GoldPickaxe extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "GOLD_PICKAXE";
    private int onMode = R.mipmap.gold_pickaxe_on;
    private int offMode = R.mipmap.gold_pickaxe_off;
    private int help = R.mipmap.gold_pickaxe_craft;
    private BaseJobController baseJobController;
    private static GoldPickaxe instance;
    ...
    public static synchronized GoldPickaxe getInstance(Context context) {
        if (instance == null) {
            instance = new GoldPickaxe(context);
        }
        return instance;
    }


    private GoldPickaxe(Context context) {
        super(context);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(Crafttable.getInstance(context).getIT().getViewCounter()>=1
                        ...
                        && GoldIngot.getInstance(context).getIT().getViewCounter()>=3) {
                    changeStateIfClick();
