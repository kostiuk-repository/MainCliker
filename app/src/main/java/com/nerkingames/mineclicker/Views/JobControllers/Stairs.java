...
public class Stairs extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "STAIRS";
    private int onMode = R.mipmap.stairs_on;
    private int offMode = R.mipmap.stairs_off;
    private int help = R.mipmap.stairs_craft;
    ...
    public static synchronized Stairs getInstance(Context context) {
        if (instance == null) {
            instance = new Stairs(context);
        }
        return instance;
    }


    private Stairs(Context context) {
        super(context);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(Crafttable.getInstance(context).getIT().getViewCounter()>=1
                        && PlankButton.getInstance(context).getIT().getViewCounter()>=6) {
                    changeStateIfClick();
