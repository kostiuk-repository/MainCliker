...
public class DoubleHouse extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "DoubleHouse";
    private int onMode = R.mipmap.double_house_on;
    private int offMode = R.mipmap.double_house_off;
    private int help = R.mipmap.double_house_craft;
    private BaseJobController baseJobController;
    private static DoubleHouse instance;
    ...
    public static synchronized DoubleHouse getInstance(Context context) {
        if (instance == null) {
            instance = new DoubleHouse(context);
        }
        return instance;
    }


    private DoubleHouse(Context context) {
        super(context);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(VillagerWorker.getInstance(context).getIT().getViewCounter()>=1
                        && Home.getInstance(context).getIT().getViewCounter()>=4) {
                    changeStateIfClick();
