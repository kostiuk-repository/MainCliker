...
public class LeatherHelmet extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "LEATHER_HELMET";
    private int onMode = R.mipmap.leather_helmet_on;
    private int offMode = R.mipmap.leather_helmet_off;
    private int help = R.mipmap.leather_helmet_craft;
    private BaseJobController baseJobController;
    private static LeatherHelmet instance;
    ...
    public static synchronized LeatherHelmet getInstance(Context context) {
        if (instance == null) {
            instance = new LeatherHelmet(context);
        }
        return instance;
    }


    private LeatherHelmet(Context context) {
        super(context);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(VillagerLeather.getInstance(context).getIT().getViewCounter()>=1
                        && Leather.getInstance(context).getIT().getViewCounter()>=5) {
                    changeStateIfClick();
