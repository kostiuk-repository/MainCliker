...
public class StorogkaUpdate extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "Storogka_update";
    private int onMode = R.mipmap.storogka01_on;
    private int offMode = R.mipmap.storogka01_off;
    private int help = R.mipmap.storogka001_on;
    private BaseJobController baseJobController;
    private static StorogkaUpdate instance;
    ...
    public static synchronized StorogkaUpdate getInstance(Context context) {
        if (instance == null) {
            instance = new StorogkaUpdate(context);
        }
        return instance;
    }


    private StorogkaUpdate(Context context) {
        super(context);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(Storogka.getInstance(context).getIT().getViewCounter()>=2
                        && VillagerLetherSoldat.getInstance(context).getIT().getViewCounter()>=8) {
                    changeStateIfClick();
