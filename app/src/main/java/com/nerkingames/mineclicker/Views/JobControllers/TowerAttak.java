...
public class TowerAttak extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "TOWER_ATTAK";
    private int onMode = R.mipmap.tower_attak_on;
    private int offMode = R.mipmap.tower_attak_off;
    private int help = R.mipmap.tower_attak_craft;
    private BaseJobController baseJobController;
    private static TowerAttak instance;
    ...
    public static synchronized TowerAttak getInstance(Context context) {
        if (instance == null) {
            instance = new TowerAttak(context);
        }
        return instance;
    }


    private TowerAttak(Context context) {
        super(context);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(VillagerStroitel.getInstance(context).getIT().getViewCounter()>=1
                        ...
                        && VillagerFireTeam.getInstance(context).getIT().getViewCounter()>=1) {
                    changeStateIfClick();
