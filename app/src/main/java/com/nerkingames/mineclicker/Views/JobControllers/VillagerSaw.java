...
public class VillagerSaw extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "VILLAGER_SAW";
    private int onMode = R.mipmap.villager_saw_on;
    private int offMode = R.mipmap.villager_saw_off;
    private int help = R.mipmap.villager_saw_craft;
    private BaseJobController baseJobController;
    private static VillagerSaw instance;
    ...
    public static synchronized VillagerSaw getInstance(Context context) {
        if (instance == null) {
            instance = new VillagerSaw(context);
        }
        return instance;
    }


    private VillagerSaw(Context context) {
        super(context);
        ...
        baseJobController = new BaseJobController.Builder(context)
                ...
                .setOff(offMode)
                .setHelp(help)
                .setCompareList(1,1,0,0,0,0,0,0)
                ...
                .setMinusValueList(-1,-1,0,0,0,0,0,0)
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(EducatedVillager.getInstance(context).getIT().getViewCounter()>=1
                        && Saw.getInstance(context).getIT().getViewCounter()>=1) {
                    changeStateIfClick();
