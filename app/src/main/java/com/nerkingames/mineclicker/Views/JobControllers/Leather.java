...
public class Leather extends BaseJobController implements View.OnTouchListener{
    ...
    private int onMode = R.mipmap.lather_on;
    private int offMode = R.mipmap.lather_off;
    private int help = R.mipmap.lather_craft;
    private BaseJobController baseJobController;


    private static Leather instance;
    ...
    public static synchronized Leather getInstance(Context context) {
        if (instance == null) {
            instance = new Leather(context);
        }
        return instance;
    }
    ...
    public Leather(Context context) {
        ...
        baseJobController = new BaseJobController.Builder(context)
                ...
                .build();
        sampleAchievements = new SampleAchievements(context,R.mipmap.leather09);
    }
    ...
    public void subscribe(Observable<Integer> observer){
        observer.subscribe(new Observer<Integer>() {
            ...
            public void onNext(Integer o) {
                ...
                if(Leather.getInstance(context).getIT().getViewCounter() == 0){
                    if(baseJobController.getJobEntity().getTotalCounter() == 0) {

                        sampleAchievements = new SampleAchievements(context,R.mipmap.leather09);
                        sampleAchievements.insertNewEntity("LEATHER");
