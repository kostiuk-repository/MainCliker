...
public class IronOre extends BaseJobController implements View.OnTouchListener{


    private VillagerAutosmelt villagerAutosmelt;
    Context context;
    public static final String ID = "IRON_ORE";
    private int onMode = R.mipmap.iron_ore_on;
    private int offMode = R.mipmap.iron_ore_off;
    private int help = R.mipmap.iron_ore_craft;
    ...
    public static synchronized IronOre getInstance(Context context) {
        if (instance == null) {
            instance = new IronOre(context);
        }
        return instance;
    }

    public IronOre(Context context) {
        super(context);
        ...
        villagerAutosmelt.setIronOre(this);
    }
