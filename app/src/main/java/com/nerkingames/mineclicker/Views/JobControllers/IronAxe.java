...
public class IronAxe extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "IRON_AXE";
    private int onMode = R.mipmap.iron_axe_on;
    private int offMode = R.mipmap.iron_axe_off;
    private int help = R.mipmap.iron_axe_craft;
    ...
    public static synchronized IronAxe getInstance(Context context) {
        if (instance == null) {
            instance = new IronAxe(context);
        }
        return instance;
    }


    private IronAxe(Context context) {
        super(context);
