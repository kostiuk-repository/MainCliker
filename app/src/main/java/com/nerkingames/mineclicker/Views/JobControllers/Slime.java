...
public class Slime extends BaseJobController implements View.OnTouchListener{
    ...
    Context context;
    public static final String ID = "SLIME";
    private int onMode = R.mipmap.slime_on;
    private int offMode = R.mipmap.slime_off;
    private int help = R.mipmap.slime_craft;
    ...
    public static synchronized Slime getInstance(Context context) {
        if (instance == null) {
            instance = new Slime(context);
        }
        return instance;
    }
    ...
    public Slime(Context context) {
        ...
        baseJobController = new BaseJobController.Builder(context)
                ...
                .build();
        sampleAchievements = new SampleAchievements(context,R.mipmap.slime21);
    }
    ...
    public void subscribe(Observable<Integer> observer){
        observer.subscribe(new Observer<Integer>() {
            ...
            public void onNext(Integer o) {
                ...
                if(Slime.getInstance(context).getIT().getViewCounter() == 0){
                    if(baseJobController.getJobEntity().getTotalCounter() == 0) {
                        sampleAchievements = new SampleAchievements(context,R.mipmap.slime21);

                        sampleAchievements.insertNewEntity("SLIME");
