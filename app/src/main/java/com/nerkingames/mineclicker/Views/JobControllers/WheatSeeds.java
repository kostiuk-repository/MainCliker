...
public class WheatSeeds extends BaseJobController implements View.OnTouchListener{



    Context context;
    public static final String ID = "WHEAT_SEEDS";
    private int onMode = R.mipmap.wheat_seeds_on;
    private int offMode = R.mipmap.wheat_seeds_off;
    private int help = R.mipmap.wheat_seeds_craft;
    private BaseJobController baseJobController;


    private static WheatSeeds instance;
    ...
    public static synchronized WheatSeeds getInstance(Context context) {
        if (instance == null) {
            instance = new WheatSeeds(context);
        }
        return instance;
    }

    public WheatSeeds(Context context) {
        super(context);
