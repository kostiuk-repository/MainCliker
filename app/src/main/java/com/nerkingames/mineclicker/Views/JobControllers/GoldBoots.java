...
public class GoldBoots extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "GoldBoots";
    private int onMode = R.mipmap.gold_boots_on;
    private int offMode = R.mipmap.gold_boots_off;
    private int help = R.mipmap.gold_boots_craft;
    private BaseJobController baseJobController;
    private static GoldBoots instance;
    ...
    public static synchronized GoldBoots getInstance(Context context) {
        if (instance == null) {
            instance = new GoldBoots(context);
        }
        return instance;
    }


    private GoldBoots(Context context) {
        super(context);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(VillagerWorkerGold.getInstance(context).getIT().getViewCounter()>=1
                        && GoldIngot.getInstance(context).getIT().getViewCounter()>=4) {
                    changeStateIfClick();
