...
public class DiamondShovel extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "DIAMOND_SHOVEL";
    private int onMode = R.mipmap.diamond_shovel_on;
    private int offMode = R.mipmap.diamond_shovel_off;
    private int help = R.mipmap.diamond_shovel_craft;
    private BaseJobController baseJobController;
    private static DiamondShovel instance;
    ...
    public static synchronized DiamondShovel getInstance(Context context) {
        if (instance == null) {
            instance = new DiamondShovel(context);
        }
        return instance;
    }


    private DiamondShovel(Context context) {
        super(context);
