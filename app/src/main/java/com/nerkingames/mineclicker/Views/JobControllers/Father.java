...
public class Father extends BaseJobController implements View.OnTouchListener{



    Context context;
    public static final String ID = "FATHER";
    private int onMode = R.mipmap.father_on;
    private int offMode = R.mipmap.father_off;
    private int help = R.mipmap.father_craft;
    ...
    public static synchronized Father getInstance(Context context) {
        if (instance == null) {
            instance = new Father(context);
        }
        return instance;
    }
