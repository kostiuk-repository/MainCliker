...
public class IronPickaxe extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "IRON_PICKAXE";
    private int onMode = R.mipmap.iron_pickaxe_on;
    private int offMode = R.mipmap.iron_pickaxe_off;
    private int help = R.mipmap.iron_pickaxe_craft;
    private BaseJobController baseJobController;
    private static IronPickaxe instance;
    ...
    public static synchronized IronPickaxe getInstance(Context context) {
        if (instance == null) {
            instance = new IronPickaxe(context);
        }
        return instance;
    }


    private IronPickaxe(Context context) {
        super(context);
