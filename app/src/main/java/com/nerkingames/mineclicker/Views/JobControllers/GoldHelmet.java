...
public class GoldHelmet extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "GoldHelmet";
    private int onMode = R.mipmap.gold_helmet_on;
    private int offMode = R.mipmap.gold_helmet_off;
    private int help = R.mipmap.gold_helmet_craft;
    private BaseJobController baseJobController;
    private static GoldHelmet instance;
    ...
    public static synchronized GoldHelmet getInstance(Context context) {
        if (instance == null) {
            instance = new GoldHelmet(context);
        }
        return instance;
    }


    private GoldHelmet(Context context) {
        super(context);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(VillagerWorkerGold.getInstance(context).getIT().getViewCounter()>=1
                        && GoldIngot.getInstance(context).getIT().getViewCounter()>=5) {
                    changeStateIfClick();
