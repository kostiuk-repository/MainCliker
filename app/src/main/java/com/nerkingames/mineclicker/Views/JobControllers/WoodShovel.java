...
public class WoodShovel extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "SHOVEL";
    private int onMode = R.mipmap.wood_shovel_on;
    private int offMode = R.mipmap.wood_shovel_off;
    private int help = R.mipmap.wood_shovel_craft;
    private BaseJobController baseJobController;
    private static WoodShovel instance;
    ...
    public static synchronized WoodShovel getInstance(Context context) {
        if (instance == null) {
            instance = new WoodShovel(context);
        }
        return instance;
    }


    private WoodShovel(Context context) {
        super(context);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(PlankButton.getInstance(context).getIT().getViewCounter()>=1
