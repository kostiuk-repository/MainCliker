...
public class Ferma extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "FERMA";
    private int onMode = R.mipmap.ferma_on;
    private int offMode = R.mipmap.ferma_off;
    private int help = R.mipmap.ferma_craft;
    private BaseJobController baseJobController;
    private static Ferma instance;
    ...
    public static synchronized Ferma getInstance(Context context) {
        if (instance == null) {
            instance = new Ferma(context);
        }
        return instance;
    }


    private Ferma(Context context) {
        super(context);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(DirtPodzol.getInstance(context).getIT().getViewCounter()>=8
