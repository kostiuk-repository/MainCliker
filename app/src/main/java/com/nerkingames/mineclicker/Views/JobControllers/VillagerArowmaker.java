...
public class VillagerArowmaker extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "VILLAGER_AROWMAKER";
    private int onMode = R.mipmap.villager_arowmaker_on;
    private int offMode = R.mipmap.villager_arowmaker_off;
    private int help = R.mipmap.villager_arowmaker_craft;
    private BaseJobController baseJobController;
    private static VillagerArowmaker instance;
    ...
    public static synchronized VillagerArowmaker getInstance(Context context) {
        if (instance == null) {
            instance = new VillagerArowmaker(context);
        }
        return instance;
    }


    private VillagerArowmaker(Context context) {
        super(context);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(VillagerMayor.getInstance(context).getIT().getViewCounter()>=1
                        ...
                        && Arrow.getInstance(context).getIT().getViewCounter()>=1) {
                    changeStateIfClick();
