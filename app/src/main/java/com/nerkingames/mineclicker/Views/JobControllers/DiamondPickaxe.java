...
public class DiamondPickaxe extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "DIAMOND_PICKAXE";
    private int onMode = R.mipmap.diamond_pickaxe_on;
    private int offMode = R.mipmap.diamond_pickaxe_off;
    private int help = R.mipmap.diamond_pickaxe_craft;
    private BaseJobController baseJobController;
    private static DiamondPickaxe instance;
    ...
    public static synchronized DiamondPickaxe getInstance(Context context) {
        if (instance == null) {
            instance = new DiamondPickaxe(context);
        }
        return instance;
    }


    private DiamondPickaxe(Context context) {
        super(context);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(Crafttable.getInstance(context).getIT().getViewCounter()>=1
                        ...
                        && Diamond.getInstance(context).getIT().getViewCounter()>=3) {
                    changeStateIfClick();
