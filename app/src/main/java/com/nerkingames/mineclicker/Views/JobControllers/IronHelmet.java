...
public class IronHelmet extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "IRON_HELMET";
    private int onMode = R.mipmap.iron_helmet_on;
    private int offMode = R.mipmap.iron_helmet_off;
    private int help = R.mipmap.iron_helmet_craft;
    private BaseJobController baseJobController;
    private static IronHelmet instance;
    ...
    public static synchronized IronHelmet getInstance(Context context) {
        if (instance == null) {
            instance = new IronHelmet(context);
        }
        return instance;
    }


    private IronHelmet(Context context) {
        super(context);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(VillagerAutosmeltUpdte.getInstance(context).getIT().getViewCounter()>=1
                        && IronIngot.getInstance(context).getIT().getViewCounter()>=5) {
                    changeStateIfClick();
