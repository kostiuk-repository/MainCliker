...
public class VillagerPrezident extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "VILLAGER_PREZIDENT";
    private int onMode = R.mipmap.villager_prezident_on;
    private int offMode = R.mipmap.villager_prezident_off;
    private int help = R.mipmap.villager_prezident_craft;
    private BaseJobController baseJobController;
    private static VillagerPrezident instance;
    ...
    public static synchronized VillagerPrezident getInstance(Context context) {
        if (instance == null) {
            instance = new VillagerPrezident(context);
        }
        return instance;
    }


    private VillagerPrezident(Context context) {
        super(context);
