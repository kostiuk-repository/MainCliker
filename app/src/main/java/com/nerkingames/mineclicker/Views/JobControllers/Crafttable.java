...
public class Crafttable extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "CRAFTTABLE";
    private final Context context;
    private int onMode = R.mipmap.crafttable_on;
    private int offMode = R.mipmap.crafttable_off;
    private int help = R.mipmap.crafttable_craft;
    ...
    public static synchronized Crafttable getInstance(Context context) {
        if (instance == null) {
            instance = new Crafttable(context);
        }
        return instance;
    }


    private Crafttable(Context context) {
        super(context);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(PlankButton.getInstance(context).getIT().getViewCounter()>=4) {
                    changeStateIfClick();
