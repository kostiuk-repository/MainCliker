...
public class Lava extends BaseJobController implements View.OnTouchListener{



    Context context;
    public static final String ID = "LAVA";
    private int onMode = R.mipmap.lava_on;
    private int offMode = R.mipmap.lava_off;
    private int help = R.mipmap.lava_craft;
    ...
    public static synchronized Lava getInstance(Context context) {
        if (instance == null) {
            instance = new Lava(context);
        }
        return instance;
    }
