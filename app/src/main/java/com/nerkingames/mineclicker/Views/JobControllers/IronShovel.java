...
public class IronShovel extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "IRON_SHOVEL";
    private int onMode = R.mipmap.iron_shovel_on;
    private int offMode = R.mipmap.iron_shovel_off;
    private int help = R.mipmap.iron_shovel_craft;
    ...
    public static synchronized IronShovel getInstance(Context context) {
        if (instance == null) {
            instance = new IronShovel(context);
        }
        return instance;
    }


    private IronShovel(Context context) {
        super(context);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(Crafttable.getInstance(context).getIT().getViewCounter()>=1
                        ...
                        && IronIngot.getInstance(context).getIT().getViewCounter()>=1) {
                    changeStateIfClick();
