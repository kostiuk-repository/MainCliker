...
public class VillagerDiamond extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "VillagerDiamond";
    private int onMode = R.mipmap.villager_diamond_on;
    private int offMode = R.mipmap.villager_diamond_off;
    private int help = R.mipmap.villager_diamond_craft;
    private BaseJobController baseJobController;
    private static VillagerDiamond instance;
    ...
    public static synchronized VillagerDiamond getInstance(Context context) {
        if (instance == null) {
            instance = new VillagerDiamond(context);
        }
        return instance;
    }


    private VillagerDiamond(Context context) {
        super(context);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(VillagerKing.getInstance(context).getIT().getViewCounter()>=1
                        ...
                        && DiamondArmor.getInstance(context).getIT().getViewCounter()>=1) {
                    changeStateIfClick();
