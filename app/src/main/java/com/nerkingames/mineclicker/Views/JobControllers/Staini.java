...
public class Staini extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "Staini";
    private int onMode = R.mipmap.staini_on;
    private int offMode = R.mipmap.staini_off;
    private int help = R.mipmap.staini_craft;
    private BaseJobController baseJobController;
    private static Staini instance;
    ...
    public static synchronized Staini getInstance(Context context) {
        if (instance == null) {
            instance = new Staini(context);
        }
        return instance;
    }


    private Staini(Context context) {
        super(context);
        ...
        baseJobController = new BaseJobController.Builder(context)
                ...
                .setHelp(help)
                .setCompareList(1,4)
                .setStatuses(STATUS.NOTHING,STATUS.MINUS)
                .setMinusValueList(0,-4)
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(VillagerSaw.getInstance(context).getIT().getViewCounter()>=1
                        && Stoilo.getInstance(context).getIT().getViewCounter()>=4) {
                    changeStateIfClick();
