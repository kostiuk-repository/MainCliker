...
public class BookshelfUpdate  extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "BOOKSHELF_UPDATE";
    private int onMode = R.mipmap.bookshelf1_on;
    private int offMode = R.mipmap.bookshelf1_off;
    private int help = R.mipmap.bookshelf1_craft;
    private BaseJobController baseJobController;
    private static BookshelfUpdate instance;
    ...
    public static synchronized BookshelfUpdate getInstance(Context context) {
        if (instance == null) {
            instance = new BookshelfUpdate(context);
        }
        return instance;
    }


    private BookshelfUpdate(Context context) {
        super(context);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(Bookshelf.getInstance(context).getIT().getViewCounter()>=4) {
                    changeStateIfClick();
