...
public class GoldOre extends BaseJobController implements View.OnTouchListener{


    private VillagerAutosmelt villagerAutosmelt;
    Context context;
    public static final String ID = "GOLD_ORE";
    private int onMode = R.mipmap.gold_ore_on;
    private int offMode = R.mipmap.gold_ore_off;
    private int help = R.mipmap.gold_ore_craft;
    private BaseJobController baseJobController;


    private static GoldOre instance;
    ...
    public static synchronized GoldOre getInstance(Context context) {
        if (instance == null) {
            instance = new GoldOre(context);
        }
        return instance;
    }

    public GoldOre(Context context) {
        super(context);
        ...
        villagerAutosmelt.setGoldOre(this);
    }
    ...
    public void subscribe(Observable<Integer> observer){
        observer.subscribe(new Observer<Integer>() {
            ...
            public void onNext(Integer o) {
                ...
                if(villagerAutosmelt.getIT().getViewCounter() > 0){
                    villagerAutosmelt.smelt();
                }
