...
public class LeatherBoots extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "LEATHER_BOOTS";
    private int onMode = R.mipmap.leather_boots_on;
    private int offMode = R.mipmap.leather_boots_off;
    private int help = R.mipmap.leather_boots_craft;
    private BaseJobController baseJobController;
    private static LeatherBoots instance;
    ...
    public static synchronized LeatherBoots getInstance(Context context) {
        if (instance == null) {
            instance = new LeatherBoots(context);
        }
        return instance;
    }


    private LeatherBoots(Context context) {
        super(context);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(VillagerLeather.getInstance(context).getIT().getViewCounter()>=1
                        && Leather.getInstance(context).getIT().getViewCounter()>=4) {
                    changeStateIfClick();
