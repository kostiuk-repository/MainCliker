...
public class FoodWorker extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "VILLAGER_FOOD";
    private int onMode = R.mipmap.villager_food_fire_on;
    private int offMode = R.mipmap.villager_food_fire_off;
    private int help = R.mipmap.villager_food_fire_craft;
    private BaseJobController baseJobController;
    private static FoodWorker instance;
    ...
    public static synchronized FoodWorker getInstance(Context context) {
        if (instance == null) {
            instance = new FoodWorker(context);
        }
        return instance;
    }


    private FoodWorker(Context context) {
        super(context);
