...
public class WoodPickaxe extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "PICKAXE";
    private int onMode = R.mipmap.wood_pickaxe_on;
    private int offMode = R.mipmap.wood_pickaxe_off;
    private int help = R.mipmap.wood_pickaxe_craft;
    private BaseJobController baseJobController;
    private static WoodPickaxe instance;
    ...
    public static synchronized WoodPickaxe getInstance(Context context) {
        if (instance == null) {
            instance = new WoodPickaxe(context);
        }
        return instance;
    }


    private WoodPickaxe(Context context) {
        super(context);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(PlankButton.getInstance(context).getIT().getViewCounter()>=3
