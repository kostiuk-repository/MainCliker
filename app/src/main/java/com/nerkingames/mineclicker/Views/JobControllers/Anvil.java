...
public class Anvil extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "ANVIL";
    private int onMode = R.mipmap.anvil_on;
    private int offMode = R.mipmap.anvil_off;
    private int help = R.mipmap.anvil_craft;
    ...
    public static synchronized Anvil getInstance(Context context) {
        if (instance == null) {
            instance = new Anvil(context);
        }
        return instance;
    }


    private Anvil(Context context) {
        super(context);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(Crafttable.getInstance(context).getIT().getViewCounter()>=1
                        ...
                        && IronBlock.getInstance(context).getIT().getViewCounter()>=3) {
                    changeStateIfClick();
