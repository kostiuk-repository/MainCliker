...
public class VillagerStroitel extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "VILLAGER_STROITEL";
    private int onMode = R.mipmap.villager_stroitel_on;
    private int offMode = R.mipmap.villager_stroitel_off;
    private int help = R.mipmap.villager_stroitel_craft;
    private BaseJobController baseJobController;
    private static VillagerStroitel instance;
    ...
    public static synchronized VillagerStroitel getInstance(Context context) {
        if (instance == null) {
            instance = new VillagerStroitel(context);
        }
        return instance;
    }


    private VillagerStroitel(Context context) {
        super(context);
