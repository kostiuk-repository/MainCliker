...
public class BambukFerma extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "BAMBUK_FERMA";
    private int onMode = R.mipmap.bambuk_ferma_on;
    private int offMode = R.mipmap.bambuk_ferma_off;
    private int help = R.mipmap.bambuk_ferma_craft;
    private BaseJobController baseJobController;
    private static BambukFerma instance;
    ...
    public static synchronized BambukFerma getInstance(Context context) {
        if (instance == null) {
            instance = new BambukFerma(context);
        }
        return instance;
    }


    private BambukFerma(Context context) {
        super(context);
        ...
        baseJobController = new BaseJobController.Builder(context)
                ...
                .setHelp(help)
                .setCompareList(8,1)
                .setStatuses(STATUS.MINUS,STATUS.MINUS)
                .setMinusValueList(-8,-1)
    ...
    public boolean onTouch(View v, MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(Bambuk.getInstance(context).getIT().getViewCounter()>=8
                        && Ferma.getInstance(context).getIT().getViewCounter()>=1) {
                    changeStateIfClick();
