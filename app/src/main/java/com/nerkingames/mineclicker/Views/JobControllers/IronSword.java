...
public class IronSword extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "IRON_SWORD";
    private int onMode = R.mipmap.iron_sword_on;
    private int offMode = R.mipmap.iron_sword_off;
    private int help = R.mipmap.iron_sword_craft;
    ...
    public static synchronized IronSword getInstance(Context context) {
        if (instance == null) {
            instance = new IronSword(context);
        }
        return instance;
    }


    private IronSword(Context context) {
        super(context);
