...
public class WoodSword extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "SWORD";
    private int onMode = R.mipmap.wood_sword_on;
    private int offMode = R.mipmap.wood_sword_off;
    private int help = R.mipmap.wood_sword_craft;
    private BaseJobController baseJobController;
    private static WoodSword instance;
    ...
    public static synchronized WoodSword getInstance(Context context) {
        if (instance == null) {
            instance = new WoodSword(context);
        }
        return instance;
    }


    private WoodSword(Context context) {
        super(context);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(PlankButton.getInstance(context).getIT().getViewCounter()>=2
