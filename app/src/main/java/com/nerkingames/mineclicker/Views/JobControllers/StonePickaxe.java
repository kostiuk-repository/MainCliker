...
public class StonePickaxe extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "STONE_PICKAXE";
    private int onMode = R.mipmap.stone_pickaxe_on;
    private int offMode = R.mipmap.stone_pickaxe_off;
    private int help = R.mipmap.stone_pickaxe_craft;
    private BaseJobController baseJobController;
    private static StonePickaxe instance;
    ...
    public static synchronized StonePickaxe getInstance(Context context) {
        if (instance == null) {
            instance = new StonePickaxe(context);
        }
        return instance;
    }


    private StonePickaxe(Context context) {
        super(context);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(Crafttable.getInstance(context).getIT().getViewCounter()>=1
                        ...
                        && Cobbl.getInstance(context).getIT().getViewCounter()>=3) {
                    changeStateIfClick();
