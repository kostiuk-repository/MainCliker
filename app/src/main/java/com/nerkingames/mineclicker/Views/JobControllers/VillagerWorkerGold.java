...
public class VillagerWorkerGold extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "VILLAGER_WORKER_GOLD";
    private int onMode = R.mipmap.villager_worker_gold_on;
    private int offMode = R.mipmap.villager_worker_gold_off;
    private int help = R.mipmap.villager_worker_gold_craft;
    private BaseJobController baseJobController;
    private static VillagerWorkerGold instance;
    ...
    public static synchronized VillagerWorkerGold getInstance(Context context) {
        if (instance == null) {
            instance = new VillagerWorkerGold(context);
        }
        return instance;
    }


    private VillagerWorkerGold(Context context) {
        super(context);
        ...
        baseJobController = new BaseJobController.Builder(context)
                ...
                .setOff(offMode)
                .setHelp(help)
                .setCompareList(1,45,1,8,1,8,0,0,0,0)
                ...
                .setMinusValueList(0,-45,-1,-8,-1,-8,0,0,0,0)
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(Cobbl.getInstance(context).getIT().getViewCounter()>=45
                        ...
                        && VillagerMayor.getInstance(context).getIT().getViewCounter()>=1) {
                    changeStateIfClick();
