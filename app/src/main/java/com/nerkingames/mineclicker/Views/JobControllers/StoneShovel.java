...
public class StoneShovel extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "STONE_SHOVEL";
    private int onMode = R.mipmap.stone_shovel_on;
    private int offMode = R.mipmap.stone_shovel_off;
    private int help = R.mipmap.stone_shovel_craft;
    private BaseJobController baseJobController;
    private static StoneShovel instance;
    ...
    public static synchronized StoneShovel getInstance(Context context) {
        if (instance == null) {
            instance = new StoneShovel(context);
        }
        return instance;
    }


    private StoneShovel(Context context) {
        super(context);
