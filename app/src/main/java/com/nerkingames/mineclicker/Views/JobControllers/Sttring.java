...
public class Sttring extends BaseJobController implements View.OnTouchListener{



    Context context;
    public static final String ID = "STTRING";
    private int onMode = R.mipmap.string_on;
    private int offMode = R.mipmap.string_off;
    private int help = R.mipmap.string_craft;
    private BaseJobController baseJobController;


    private static Sttring instance;
    ...
    public static synchronized Sttring getInstance(Context context) {
        if (instance == null) {
            instance = new Sttring(context);
        }
        return instance;
    }

    public Sttring(Context context) {
        super(context);
