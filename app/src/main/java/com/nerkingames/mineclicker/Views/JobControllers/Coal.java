...
public class Coal extends BaseJobController implements View.OnTouchListener{



    Context context;
    public static final String ID = "COAL";
    private int onMode = R.mipmap.coal_on;
    private int offMode = R.mipmap.coal_off;
    private int help = R.mipmap.coal_craft;
    ...
    public static synchronized Coal getInstance(Context context) {
        if (instance == null) {
            instance = new Coal(context);
        }
        return instance;
    }

    public Coal(Context context) {
        super(context);
        ...
        baseJobController = new BaseJobController.Builder(context)
                ...
                .setClickable(true)
                .setStatuses(STATUS.NOTHING,STATUS.NOTHING)
                .setMinusValueList(0,0)
                .setCompareList()
        ...
        villagerAutosmelt.setCoal(this);
    }
