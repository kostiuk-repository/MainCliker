...
public class Wool extends BaseJobController implements View.OnTouchListener{



    Context context;
    public static final String ID = "WOOL";
    private int onMode = R.mipmap.wool_on;
    private int offMode = R.mipmap.wool_off;
    private int help = R.mipmap.wool_craft;
    private BaseJobController baseJobController;


    private static Wool instance;
    ...
    public static synchronized Wool getInstance(Context context) {
        if (instance == null) {
            instance = new Wool(context);
        }
        return instance;
    }

    public Wool(Context context) {
        super(context);
