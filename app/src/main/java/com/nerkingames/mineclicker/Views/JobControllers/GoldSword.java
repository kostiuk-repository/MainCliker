...
public class GoldSword extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "GOLD_SWORD";
    private int onMode = R.mipmap.gold_sword_on;
    private int offMode = R.mipmap.gold_sword_off;
    private int help = R.mipmap.gold_sword_craft;
    private BaseJobController baseJobController;
    private static GoldSword instance;
    ...
    public static synchronized GoldSword getInstance(Context context) {
        if (instance == null) {
            instance = new GoldSword(context);
        }
        return instance;
    }


    private GoldSword(Context context) {
        super(context);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(Crafttable.getInstance(context).getIT().getViewCounter()>=1
                        ...
                        && GoldIngot.getInstance(context).getIT().getViewCounter()>=2) {
                    changeStateIfClick();
