...
public class TowerBest extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "TOWER_BEST";
    private int onMode = R.mipmap.tower_best_on;
    private int offMode = R.mipmap.tower_best_off;
    private int help = R.mipmap.station_crarft;
    private BaseJobController baseJobController;
    private static TowerBest instance;
    ...
    public static synchronized TowerBest getInstance(Context context) {
        if (instance == null) {
            instance = new TowerBest(context);
        }
        return instance;
    }


    private TowerBest(Context context) {
        super(context);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(VillagerStroitel.getInstance(context).getIT().getViewCounter()>=1
                        && TowerUpdate.getInstance(context).getIT().getViewCounter()>=2) {
                    changeStateIfClick();
