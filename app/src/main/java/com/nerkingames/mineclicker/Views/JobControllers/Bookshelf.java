...
public class Bookshelf extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "BOOKSHELF";
    private int onMode = R.mipmap.bookshelf_on;
    private int offMode = R.mipmap.bookshelf_off;
    private int help = R.mipmap.bookshelf_craft;
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(Crafttable.getInstance(context).getIT().getViewCounter()>=1
                        && Book.getInstance(context).getIT().getViewCounter()>=3
