...
public class IronHoe extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "IRON_HOE";
    private int onMode = R.mipmap.iron_hoe_on;
    private int offMode = R.mipmap.iron_hoe_off;
    private int help = R.mipmap.iron_hoe_craft;
    private BaseJobController baseJobController;
    private static IronHoe instance;
    ...
    public static synchronized IronHoe getInstance(Context context) {
        if (instance == null) {
            instance = new IronHoe(context);
        }
        return instance;
    }


    private IronHoe(Context context) {
        super(context);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(Crafttable.getInstance(context).getIT().getViewCounter()>=1
                        ...
                        && IronIngot.getInstance(context).getIT().getViewCounter()>=2) {
                    changeStateIfClick();
