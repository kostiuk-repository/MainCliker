...
public class WoodHoe extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "HOE";
    private int onMode = R.mipmap.wood_hoe_on;
    private int offMode = R.mipmap.wood_hoe_off;
    private int help = R.mipmap.wood_hoe_craft;
    private BaseJobController baseJobController;
    private static WoodHoe instance;
    ...
    public static synchronized WoodHoe getInstance(Context context) {
        if (instance == null) {
            instance = new WoodHoe(context);
        }
        return instance;
    }


    private WoodHoe(Context context) {
        super(context);
