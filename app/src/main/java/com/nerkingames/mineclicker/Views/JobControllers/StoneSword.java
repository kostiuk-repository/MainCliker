...
public class StoneSword extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "STONE_SWORD";
    private int onMode = R.mipmap.stone_sword_on;
    private int offMode = R.mipmap.stone_sword_off;
    private int help = R.mipmap.stone_sword_craft;
    ...
    public static synchronized StoneSword getInstance(Context context) {
        if (instance == null) {
            instance = new StoneSword(context);
        }
        return instance;
    }


    private StoneSword(Context context) {
        super(context);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(Crafttable.getInstance(context).getIT().getViewCounter()>=1
                        ...
                        && Cobbl.getInstance(context).getIT().getViewCounter()>=2) {
                    changeStateIfClick();
