...
public class DiamondHorse extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "DiamondHorse";
    private int onMode = R.mipmap.diamond_horse_on;
    private int offMode = R.mipmap.diamond_horse_off;
    private int help = R.mipmap.diamond_horse_craft;
    private BaseJobController baseJobController;
    private static DiamondHorse instance;
    ...
    public static synchronized DiamondHorse getInstance(Context context) {
        if (instance == null) {
            instance = new DiamondHorse(context);
        }
        return instance;
    }


    private DiamondHorse(Context context) {
        super(context);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(VillagerWorkDiamond.getInstance(context).getIT().getViewCounter()>=1
                        && Diamondblock.getInstance(context).getIT().getViewCounter()>=4
                        && TamedHorse.getInstance(context).getIT().getViewCounter()>=1) {
                    changeStateIfClick();
