...
public class StoneHoe extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "STONE_HOE";
    private int onMode = R.mipmap.stone_hoe_on;
    private int offMode = R.mipmap.stone_hoe_off;
    private int help = R.mipmap.stone_hoe_craft;
    private BaseJobController baseJobController;
    private static StoneHoe instance;
    ...
    public static synchronized StoneHoe getInstance(Context context) {
        if (instance == null) {
            instance = new StoneHoe(context);
        }
        return instance;
    }


    private StoneHoe(Context context) {
        super(context);
