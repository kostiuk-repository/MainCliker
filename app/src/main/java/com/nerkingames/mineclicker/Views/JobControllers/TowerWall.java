...
public class TowerWall extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "TowerWall";
    private int onMode = R.mipmap.towe_wall_on;
    private int offMode = R.mipmap.towe_wall_off;
    private int help = R.mipmap.towe_wall_craft;
    private BaseJobController baseJobController;
    private static TowerWall instance;
    ...
    public static synchronized TowerWall getInstance(Context context) {
        if (instance == null) {
            instance = new TowerWall(context);
        }
        return instance;
    }


    private TowerWall(Context context) {
        super(context);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(Castle.getInstance(context).getIT().getViewCounter()>=1
                        && TowerThree.getInstance(context).getIT().getViewCounter()>=4) {
                    changeStateIfClick();
