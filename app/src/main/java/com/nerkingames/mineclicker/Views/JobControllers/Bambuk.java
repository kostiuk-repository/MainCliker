...
public class Bambuk extends BaseJobController implements View.OnTouchListener{



    Context context;
    public static final String ID = "BAMBUK";
    private int onMode = R.mipmap.bambuk_on;
    private int offMode = R.mipmap.bambuk_off;
    private int help = R.mipmap.bambuk_craft;
    private BaseJobController baseJobController;


    private static Bambuk instance;
    ...
    public static synchronized Bambuk getInstance(Context context) {
        if (instance == null) {
            instance = new Bambuk(context);
        }
        return instance;
    }

    public Bambuk(Context context) {
        super(context);
