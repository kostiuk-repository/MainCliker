...
public class Wheat extends BaseJobController implements View.OnTouchListener{
    ...
    private int onMode = R.mipmap.wheat_on;
    private int offMode = R.mipmap.wheat_off;
    private int help = R.mipmap.wheat_craft;
    ...
    public static synchronized Wheat getInstance(Context context) {
        if (instance == null) {
            instance = new Wheat(context);
        }
        return instance;
    }

    public Wheat(Context context) {
        super(context);
        ...
        baseJobController = new BaseJobController.Builder(context)
                ...
                .setMinusValueList(0,0,0,0)
                .setCompareList()
                .setBaseJobControllerListSubscribers()
                .setBaseJobControllerListSubscriptions()
                .build();
        sampleAchievements = new SampleAchievements(context,R.mipmap.wheat03);
    }
    ...
    public void subscribe(Observable<Integer> observer){
        observer.subscribe(new Observer<Integer>() {
            ...
            public void onNext(Integer o) {
                if(Wheat.getInstance(context).getIT().getViewCounter() == 0){
                    if(baseJobController.getJobEntity().getTotalCounter() == 0) {
                        ...
                        sampleAchievements = new SampleAchievements(context,R.mipmap.wheat03);
                        sampleAchievements.insertNewEntity("WHEAT");
