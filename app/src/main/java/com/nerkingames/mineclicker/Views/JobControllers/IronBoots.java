...
public class IronBoots extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "IRON_BOOTS";
    private int onMode = R.mipmap.iron_boots_on;
    private int offMode = R.mipmap.iron_boots_off;
    private int help = R.mipmap.iron_boots_craft;
    private BaseJobController baseJobController;
    private static IronBoots instance;
    ...
    public static synchronized IronBoots getInstance(Context context) {
        if (instance == null) {
            instance = new IronBoots(context);
        }
        return instance;
    }


    private IronBoots(Context context) {
        super(context);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(VillagerAutosmeltUpdte.getInstance(context).getIT().getViewCounter()>=1
                        && IronIngot.getInstance(context).getIT().getViewCounter()>=4) {
                    changeStateIfClick();
