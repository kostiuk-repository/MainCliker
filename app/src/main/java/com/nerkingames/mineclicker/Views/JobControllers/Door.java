...
public class Door extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "door";
    private int onMode = R.mipmap.door_on;
    private int offMode = R.mipmap.door_off;
    private int help = R.mipmap.door_craft;
    ...
    public static synchronized Door getInstance(Context context) {
        if (instance == null) {
            instance = new Door(context);
        }
        return instance;
    }
