...
public class VillagerWorker extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "VILLAGER_WORKER";
    private int onMode = R.mipmap.villager_worker_on;
    private int offMode = R.mipmap.villager_worker_off;
    private int help = R.mipmap.villager_worker_craft;
    private BaseJobController baseJobController;
    private static VillagerWorker instance;
    ...
    public static synchronized VillagerWorker getInstance(Context context) {
        if (instance == null) {
            instance = new VillagerWorker(context);
        }
        return instance;
    }


    private VillagerWorker(Context context) {
        super(context);
        ...
        baseJobController = new BaseJobController.Builder(context)
                ...
                .setOff(offMode)
                .setHelp(help)
                .setCompareList(1,45,1,8,1,8,0,0,0,0,0,0,0)
                .setStatuses(STATUS.NOTHING,STATUS.MINUS,STATUS.MINUS,STATUS.MINUS
                        ...
                        ,STATUS.NOTHING)
                .setMinusValueList(0,-45,-1,-8,-1,-8,0,0,0,0,0,0,0)
