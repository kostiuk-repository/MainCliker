...
public class Pitchwork extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "PITCHWORK";
    private int onMode = R.mipmap.pitchwork_on;
    private int offMode = R.mipmap.pitchwork_off;
    private int help = R.mipmap.pitchwork_craft;
    private BaseJobController baseJobController;
    private static Pitchwork instance;
    ...
    public static synchronized Pitchwork getInstance(Context context) {
        if (instance == null) {
            instance = new Pitchwork(context);
        }
        return instance;
    }


    private Pitchwork(Context context) {
        super(context);
