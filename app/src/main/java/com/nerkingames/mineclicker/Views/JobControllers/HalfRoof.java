...
public class HalfRoof extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "HALF_ROOF";
    private int onMode = R.mipmap.krisha02_on;
    private int offMode = R.mipmap.krisha02_off;
    private int help = R.mipmap.krisha02_craft;
    private BaseJobController baseJobController;
    private static HalfRoof instance;
    ...
    public static synchronized HalfRoof getInstance(Context context) {
        if (instance == null) {
            instance = new HalfRoof(context);
        }
        return instance;
    }


    private HalfRoof(Context context) {
        super(context);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(Stairs.getInstance(context).getIT().getViewCounter()>=3) {
                    changeStateIfClick();
