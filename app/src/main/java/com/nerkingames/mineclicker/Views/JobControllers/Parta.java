...
public class Parta extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "PARTA";
    private int onMode = R.mipmap.parta_on;
    private int offMode = R.mipmap.parta_off;
    private int help = R.mipmap.parta_craft;
    private BaseJobController baseJobController;
    private static Parta instance;
    ...
    public static synchronized Parta getInstance(Context context) {
        if (instance == null) {
            instance = new Parta(context);
        }
        return instance;
    }


    private Parta(Context context) {
        super(context);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(Stairs.getInstance(context).getIT().getViewCounter()>=2) {
                    changeStateIfClick();
