...
public class WheahPool extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "WheahPool";
    private int onMode = R.mipmap.wheah_pool_on;
    private int offMode = R.mipmap.wheah_pool_off;
    private int help = R.mipmap.wheah_pool_craft;
    private BaseJobController baseJobController;
    private static WheahPool instance;
    ...
    public static synchronized WheahPool getInstance(Context context) {
        if (instance == null) {
            instance = new WheahPool(context);
        }
        return instance;
    }


    private WheahPool(Context context) {
        super(context);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(WheatBlock.getInstance(context).getIT().getViewCounter()>=8) {
                    changeStateIfClick();
