...
public class GoldHoe extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "GOLD_HOE";
    private int onMode = R.mipmap.gold_hoe_on;
    private int offMode = R.mipmap.gold_hoe_off;
    private int help = R.mipmap.gold_hoe_craft;
    private BaseJobController baseJobController;
    private static GoldHoe instance;
    ...
    public static synchronized GoldHoe getInstance(Context context) {
        if (instance == null) {
            instance = new GoldHoe(context);
        }
        return instance;
    }


    private GoldHoe(Context context) {
        super(context);
