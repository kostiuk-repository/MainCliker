...
public class WallTowerUpgrade extends BaseJobController implements View.OnTouchListener{


    public static final String ID = "WallTowerUpdate";
    private int onMode = R.mipmap.wall_tower_upgrade_on;
    private int offMode = R.mipmap.wall_tower_upgrade_off;
    private int help = R.mipmap.wall_tower_upgrade_craft;
    private BaseJobController baseJobController;
    private static WallTowerUpgrade instance;
    ...
    public static synchronized WallTowerUpgrade getInstance(Context context) {
        if (instance == null) {
            instance = new WallTowerUpgrade(context);
        }
        return instance;
    }


    private WallTowerUpgrade(Context context) {
        super(context);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(WallTower.getInstance(context).getIT().getViewCounter()>=3
